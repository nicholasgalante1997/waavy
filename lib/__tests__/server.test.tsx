...
import { loadModule,  pipeComponentToWritableCallback } from '../server';

describe('loadModule', () => {
    test('loads a component', async () => {
        const component = await loadModule('lib/__tests__/.app/components/Component.tsx');
        expect(component).toBeDefined();
        expect(component).toBe(Component);
    });

    test('loads a named component', async () => {
        const component = await loadModule('lib/__tests__/.app/components/Component.tsx', 'Component');
        expect(component).toBeDefined();
        expect(component).toBe(Component);
    });
});
