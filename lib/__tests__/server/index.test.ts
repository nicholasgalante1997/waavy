...
} from '@/server'; // Adjust import path
...
describe('transformComponentToString', () => {
  ...
  it('should handle component with fragments', () => {
    const FragmentComponent = () => React.createElement(React.Fragment, null,
...
describe('transformComponentToReadableStream', () => {
  ...
  it('should handle streaming options', async () => {
    ...
    renderStreamSpy.mockResolvedValue(mockStream);
  ...
  it('should handle large components', async () => {
    const LargeComponent = () => React.createElement('div', null,
...
describe('pipeComponent', () => {
  ...
  it('should handle writable stream errors', async () => {
    ...
    await expect(pipeComponent(component, errorStream))
...
describe('pipeComponentToWritableCallback', () => {
  ...
  it('should handle callback errors', async () => {
    ...
    await expect(pipeComponentToWritableCallback(component, () => {
...
describe('pipeComponentToNodeStream', () => {
  ...
  it('should handle WriteStream errors', async () => {
    ...
    await expect(pipeComponentToNodeStream(component, errorWriteStream))
  ...
  it('should handle ReadableStream conversion errors', async () => {
    ...
    await expect(pipeComponentToNodeStream(component, mockWriteStream))
  ...
  it('should handle backpressure correctly', async () => {
    ...
    await pipeComponentToNodeStream(component, slowWriteStream);
    const duration = Date.now() - startTime;
    
    expect(writeCallCount).toBeGreaterThan(0);
    expect(duration).toBeGreaterThan(5); // Should take some time due to delays
  });
});
...
describe('Edge cases and performance', () => {
  ...
  it('should handle components with many siblings', () => {
    const ManyChildrenComponent = () => React.createElement('div', null,
      ...Array.from({ length: 100 }, (_, i) => 
  ...
  it('should handle components with special characters', () => {
    const SpecialCharsComponent = () => React.createElement('div', null,
